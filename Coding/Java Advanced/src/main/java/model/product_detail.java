...
public class product_detail {
	...
	public product_detail(String product_name, String cost, String brand, String description, String product_category,
		...
		this.cloth = cloth;
		this.imageUrlFromPart = getImageName(part, product_name);
	}
	public String getImageUrlFromPart() {
		return imageUrlFromPart;
	}
	
	public void setImageUrlFromPart(Part part, String pname) {
		this.imageUrlFromPart = getImageName(part, pname);
	}
